"""Run example 02_csv_input: one CSV row to one CSV artifact row."""
...
INPUT_PATH = EXAMPLE_DIR / "input" / "input.csv"


def main() -> None:
    """Build the worker and run the CSV input pipeline once.
