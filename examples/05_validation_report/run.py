"""Run example 05_validation_report: mixed input with validation diagnostics."""
...
def main() -> None:
    """Build the worker and run the validation-report pipeline once.

    Returns:
        None. The function prints the execution status, diagnostics summary,
    ...
    diagnostics = tuple(report.validation_report.diagnostics or ())
